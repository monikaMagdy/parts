...
<br>
      ...
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Car Infromation</h2>
...
<div class="row">
	...
	<section class="page-section" id="contact">
		<div class="container">
		  <div class="row">
			<div class="col-lg-12 text-center">
			  <h2 class="section-heading text-uppercase"> Car Edit</h2>
			  <h3 class="section-subheading text-muted"> </h3>
			</div>
		  </div>';
		...
		foreach ($this->model->getCars() as $Car) 
		{
			if ($Car->getCarID()===$id) 
			{
                $str.="<form action='Car.php?action=editAction&id=".$Car->getCarID()."' method='POST'>";               
				 $str.="
				 <div class='form-group'>
				 <div>
				 <input type='text' class='form-control'  name='CarName' value='".$Car->getCarName() ."'> 
				 </div>
				 </div> ";
				$str.=" <div class='form-group'>
				<div>
				<input type='text' class='form-control'  name='CarModel' value='".$Car->getCarModel() ."'> 
				</div>
				</div>";
				$str.=" <div class='form-group'>
				<div>
				<input type='text' class='form-control'  name='CarYear' value='".$Car->getCarYear() ."'> 
				</div>
				</div>";
				...
				<button type='submit' class='btn btn-warning'
					 name='edit' id='edit' 
					 onclick=\"location.href='Car.php?action=editAction&id=".$Car->getCarID()."'\">
					Edit'".$Car->getCarName() ."'</button>
					</div>
				</div>
			</div>";
			$str.="</form>";
