...
<div class="row">
    ...
    public function viewEditCar($id)
    {
		...
		<head>
		  ...
		  <title>Auto Spare Car/Edit Car</title>
	...
	<h2>Edit Car</h2>
		...
		foreach ($this->model->getCars() as $Car) 
		{
				...
				action='Car.php?action=editAction&id=".$Car->getCarID()."' method='post'>";               
				 ...
				 <input type='text' class='form-control' required='required' name='CarName' value='".$Car->getCarName() ."'> 
				 </div> ";
				$str.="<div class='form-group'>
				<input type='text' class='form-control' required='required' name='CarModel' value='".$Car->getCarModel() ."'> 
				</div>";
				$str.="<div class='form-group'>
				<input type='text' class='form-control' required='required' name='CarYear' value='".$Car->getCarYear() ."'> 
				</div>";
